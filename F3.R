...
save(auc_external_mean_e,file='01_data/plot_data/F3A.RData')
...
pdf("./02_figure/Fig3A.pdf", height = 2.8, width = 5.5)
p
dev.off()
...
save(auc_external_mean_e_i,file='01_data/plot_data/F3B.RData')
...
pdf("./02_figure/Fig3B.pdf", height = 2.8, width = 7)
p
dev.off()
...
save(p_r_test,file = '01_data/plot_data/F3C_left.RData')
...
save(p_r_test,file = '01_data/plot_data/F3C_right.RData')
...
p=p1+p2
p
pdf("./02_figure/Fig3C.pdf", height = 3.3, width = 7)
p
dev.off()
...
save(p_r,file = '01_data/plot_data/F3D_left.RData')
...
save(p_r,file = '01_data/plot_data/F3D_right.RData')
