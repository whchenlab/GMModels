...
save(mydata,file = '01_data/plot_data/FS3AB.RData')
...
pdf("01_figure/FigS3A.pdf", height = 5, width = 5)
p
dev.off()
...
pdf("01_figure/FigS3B.pdf", height = 5, width = 5)
p
dev.off()
...
save(self.e,file = '01_data/plot_data/FS3C.RData')
...
pdf("./02_figure/FigS3C.pdf", height = 4.5, width = 3)
p
dev.off()
...
save(data,file = '01_data/plot_data/FS3D.RData')
...
pdf("./02_figure/FigS3D.pdf", height = 4.5, width = 5.5)
p
dev.off()
